<template>
  <v-app>
        ...
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity__title">もくもく会</span>
            </div>
    ...
    <section class="competitive-programming">
      <v-container>
        <v-row>
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity__title">競技プログラミング振り返り会</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="voluntary-seminar">
      <v-container>
        <v-row>
          <v-col
            cols="12"
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity__title">自主ゼミ</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="contract-based-development">
      <v-container>
        <v-row>
          <v-col
            cols="12"
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity__title">受託開発</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
    ...
    <section class="in-house-development">
      <v-container>
        <v-row>
          <v-col
            cols="12"
          ...
          >
            <div class="text-h2 text-center">
              <span class="activity__title">自社開発</span>
            </div>
            <hr class="primary" color="primary">
            <p class="text-justify content activity_text">
